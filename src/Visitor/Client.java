...
public class Client {
	...
	public static void main(String[] args) {
		...
		TimeAndMaterialsContract projectGama = new TimeAndMaterialsContract(150, 10);
		TimeAndMaterialsContract projectDelta = new TimeAndMaterialsContract(50, 50);
		
		List<ReportElement> projects = List.of(projectAlpha, projectBeta, projectDelta, projectGama);
		...
		System.out.println("Mothly cost is: " + monthlyCost);
